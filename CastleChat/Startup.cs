...
using CastleChat.Services.Mocks;
...
namespace CastleChat
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<CastleChatContext>(options => options.UseSqlServer(Configuration.GetConnectionString("CastleChatDb")));
